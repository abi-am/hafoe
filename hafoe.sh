...
usage="\nProgram:\thafoe
\nVersion:\t1.0.0
\n\nusage:\t./hafoe.sh [options] { -parentlib <fa> -chimericlib <csv, fq> -enrichedlib1 <fq1_directory> -enrichedlib2 <fq2_directory> -exploreout <explore_output_directory> -o <o>}
\n\nInput:
\n\n\t<fa>\tfasta file (required when --explore specified: the full path to parental sequences)
\n\n\t<csv, fq>\tcsv or fastq file (required when --explore specified: the full path to chimeric sequences)
\n\n\t<fq1_directory>\tdirectory with fastq file(s) (required when --explore, --identify specified: the full path to the directory with sequences after 1st enrichment cycle of one or more samples  e.g. your_fq_folder)
\n\n\t<fq2_directory>\tdirectory with fastq file(s) (required when --explore, --identify specified: the full path to the directory with sequences after 2nd enrichment cycle)
\n\n\t<explore_output_directory>\t (required when only --identify specified: the full path to output directory generated by running hafoe with only --explore option)
